export default function Paginacion(props: PaginacionProps) {
    ...
    const totalPaginas = Math.ceil(props.cantidadTotalRegistros / props.registrosPorPagina); // Redondea hacia arriba (ej 5.7 => 6)
    const radio = Math.floor(cantidadMaximaPaginasMostrar / 2); // Cantidad paginas anteriores y siguientes a mostrar
                ...
                <div className="row align-items-start justify-content-center">
                    ...
                    <div className="col">
                        <ul className="pagination justify-content-center mb-0">
                            ...
                            {paginas.map(pagina =>
                                <li key={pagina} className={`page-item ${props.paginaActual === pagina ? 'active' : ''}`}>
                                    <button className="page-link"
